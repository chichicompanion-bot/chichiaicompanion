...
const SERVICE_MAP = {
  ...
  fb_story_view:   process.env.SVC_FB_STORY_VIEW   || null,
  fb_page_like:    process.env.SVC_FB_PAGE_LIKE    || null,
  fb_event:        process.env.SVC_FB_EVENT        || null,
  fb_save:         process.env.SVC_FB_SAVE         || null,
  ...
  ig_impression:    process.env.SVC_IG_IMPRESSION    || null,
  ig_profile_visit: process.env.SVC_IG_PROFILE_VISIT || null,
  ...
  tt_profile_view: process.env.SVC_TT_PROFILE_VIEW || null,
  tt_favorite:     process.env.SVC_TT_FAVORITE     || null,
  ...
  yt_live_view:    process.env.SVC_YT_LIVE_VIEW    || null,
  yt_like_comment: process.env.SVC_YT_LIKE_COMMENT || null,
  ...
  tw_quote:    process.env.SVC_TW_QUOTE    || null,
  tw_poll:     process.env.SVC_TW_POLL     || null,

  // ── Telegram ─────────────────────────────────────────────
  tg_member:   process.env.SVC_TG_MEMBER   || null,
  tg_view:     process.env.SVC_TG_VIEW     || null,
  tg_react:    process.env.SVC_TG_REACT    || null,
  tg_share:    process.env.SVC_TG_SHARE    || null,
  tg_poll_vote:process.env.SVC_TG_POLL_VOTE|| null,
  tg_online:   process.env.SVC_TG_ONLINE   || null,

  // ── Spotify ───────────────────────────────────────────────
  sp_stream:          process.env.SVC_SP_STREAM          || null,
  sp_follow_artist:   process.env.SVC_SP_FOLLOW_ARTIST   || null,
  sp_follow_playlist: process.env.SVC_SP_FOLLOW_PLAYLIST || null,
  sp_save:            process.env.SVC_SP_SAVE            || null,
  sp_monthly:         process.env.SVC_SP_MONTHLY         || null,
  sp_podcast:         process.env.SVC_SP_PODCAST         || null,

  // ── Zalo ─────────────────────────────────────────────────
  zl_follow:   process.env.SVC_ZL_FOLLOW   || null,
  zl_like:     process.env.SVC_ZL_LIKE     || null,
  zl_comment:  process.env.SVC_ZL_COMMENT  || null,
  zl_reaction: process.env.SVC_ZL_REACTION || null,
  zl_group:    process.env.SVC_ZL_GROUP    || null,
  zl_view:     process.env.SVC_ZL_VIEW     || null,
  ...
  tx_tg:        process.env.SVC_TX_TG        || null,
  ...
  seo_bing:     process.env.SVC_SEO_BING     || null,
  ...
  rv_tiktok_shop: process.env.SVC_RV_TIKTOK_SHOP || null,
  rv_sendo:       process.env.SVC_RV_SENDO       || null,
};
